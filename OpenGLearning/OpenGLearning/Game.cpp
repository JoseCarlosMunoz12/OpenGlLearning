...
void Game::initModels()
{
	...
	this->models.push_back(new Model("Sphere1",
		glm::vec3(0.f, 3.f, this->MipMapsData[0]->ReturnValue(-6.f, 3.f)),
		this->MatTest[1],
	...
	this->models.push_back(new Model("Cube",
		glm::vec3(0.f, 0.f, this->MipMapsData[0]->ReturnValue(10.f, -3.f)),
		this->MatTest[1],
		{ this->textures[10],this->textures[10],
		this->textures[14],this->textures[15],this->textures[16] },
		meshes[4], { Monk }));
	this->models.push_back(new Model("Triangle",
		glm::vec3(0.f, 0.f, this->MipMapsData[0]->ReturnValue(4.f, 3.f)),
		this->MatTest[1],
		{ this->textures[10],this->textures[10],
		this->textures[14],this->textures[15],this->textures[16] },
		meshes[6], { Monk }));
