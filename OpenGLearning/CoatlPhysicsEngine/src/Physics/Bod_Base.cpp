...
Bod_Base::Bod_Base(glm::vec3 InitPos)
	:Pos(InitPos),AccumForce(glm::vec3(0.f)),Vel(glm::vec3(0.f)), LinDamp(0.8f), InvMass(0.f)
	, RotVel(glm::vec3(0.f)), RotDamp(1.f),Motion(0.f),PrevAccel(glm::vec3(0.f)), Friction(10.f), Restitution(0.4f)
{
...
Bod_Base::Bod_Base(glm::vec3 InitPos, glm::vec3 InitVel)
	...
	LinDamp(.8f), InvMass(0.f),RotVel(glm::vec3(0.f)),RotDamp(1.f)	
...
Bod_Base::Bod_Base(glm::vec3 InitPos, glm::vec3 InitVel, float InitDamp)
	: Pos(InitPos), AccumForce(glm::vec3(0.f)), Vel(InitVel),
	LinDamp(InitDamp), InvMass(0.f), RotVel(glm::vec3(1.f)), RotDamp(1.f)
	, Motion(0.f), PrevAccel(glm::vec3(0.f)), Friction(10.f), Restitution(0.4f)
{
	this->AxisAngle = glm::angleAxis(0.f, glm::vec3(1.f, 0.f, 0.f));
}
