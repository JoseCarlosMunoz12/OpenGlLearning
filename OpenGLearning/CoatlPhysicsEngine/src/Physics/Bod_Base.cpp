...
Bod_Base::Bod_Base(glm::vec3 InitPos)
	...
	, RotVel(glm::vec3(0.f)), RotDamp(.8f),Motion(0.f),PrevAccel(glm::vec3(0.f)), Friction(10.f), Restitution(0.4f)
{
...
Bod_Base::Bod_Base(glm::vec3 InitPos, glm::vec3 InitVel)
	...
	LinDamp(.8f), InvMass(0.f),RotVel(glm::vec3(0.8f)),RotDamp(1.f)	
